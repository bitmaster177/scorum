...
struct withdrawals_history_object : public object<HistoryType, withdrawals_history_object<HistoryType>>
{
    CHAINBASE_DEFAULT_DYNAMIC_CONSTRUCTOR(withdrawals_history_object, (progress))

    typedef typename object<HistoryType, withdrawals_history_object<HistoryType>>::id_type id_type;
...
using account_history_object = history_object<account_all_operations_history_object_type>;
using transfers_to_scr_history_object = history_object<account_scr_to_scr_transfers_history_object_type>;
using transfers_to_sp_history_object = history_object<account_scr_to_sp_transfers_history_object_type>;
using withdrawals_to_scr_history_object = withdrawals_history_object<account_sp_to_scr_withdrawals_history_object_type>;
